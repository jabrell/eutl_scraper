...
class TransactionItem(scrapy.Item):
    ...
    transactionStatus = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    transferringRegistry = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    ...
    acquiringRegistry = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    acquiringAccountType = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    acquiringAccountName = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    acquiringAccountIdentifier = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    acquiringAccountHolderName = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    amount = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
...
class TransactionBlockItem(scrapy.Item):
    ...
    transactionBlock = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    transactionURL = scrapy.Field(
        input_processor=MapCompose(strip_values), output_processor=TakeFirst()
    )
    ...
    transferringAccountURL = scrapy.Field(
        input_processor=MapCompose(strip_values, convert_relative_url),
    ...
    acquiringAccountURL = scrapy.Field(
        input_processor=MapCompose(strip_values, convert_relative_url),
        output_processor=TakeFirst(),
    )
